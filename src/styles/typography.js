...
export const Header1 = css(
  ({
    ...
    letter-spacing: ${typographySpacing.header1};
`,
);
export const Header2 = css(
  ({
    theme: {
      ...
      letter-spacing: ${typographySpacing.header2};
  `,
);
export const Header3 = css(
  ({
    theme: {
      ...
      letter-spacing: ${typographySpacing.header3};
  `,
);
export const Header4 = css(
  ({
    theme: {
      ...
      letter-spacing: ${typographySpacing.header4};
  `,
);
export const Header5 = css(
  ({
    theme: {
      ...
      letter-spacing: ${typographySpacing.header5};
  `,
);
export const Header6 = css(
  ({
    theme: {
      ...
      letter-spacing: ${typographySpacing.header6};
  `,
);
export const ParagraphBig = css(
  ({
    theme: {
      ...
      letter-spacing: ${typographySpacing.paragraphBig};
  `,
);
export const ParagraphSmall = css(
  ({
    theme: {
      ...
      letter-spacing: ${typographySpacing.paragraphSmall};
  `,
);
